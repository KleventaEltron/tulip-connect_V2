...
{
    if (RealTimeData1[ADDRESS_RUNNING_STATUS_1 - REGISTERS_AMOUNT_REAL_TIME_DATA_1][PARAMETER_ARRAY_DATA_READ_FROM_HEATPUMP][MASTER_HEATPUMP_IN_CASCADE] & (1 << RUNNING_STATUS_1_SYSTEM_DEFROST_BIT)){
