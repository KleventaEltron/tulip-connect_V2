...
void restoreEepromValuesToDefault(void)
{
    ...
    WriteSmartEeprom16(SEEP_ADDR_HOT_WATER_MIN_TIME_IN_HOT_WATER_MODE, 300);
    ...
    WriteSmartEeprom16(SEEP_ADDR_DAY_COUNTER_STERILIZATION, 7);
    ...
    WriteSmartEeprom16(SEEP_ADDR_START_TIME_SILENT_MODE, 1320);
    WriteSmartEeprom16(SEEP_ADDR_END_TIME_SILENT_MODE, 360);
    WriteSmartEeprom8(SEEP_ADDR_BOOST_MODE, false);
    WriteSmartEeprom8(SEEP_ADDR_USE_SILENT_MODE_TIMERS, false);
    WriteSmartEeprom8(SEEP_ADDR_BLOCK_HOTWATER, false);
    WriteSmartEeprom16(SEEP_ADDR_START_TIME_BLOCK_HOTWATER, 1320);
    WriteSmartEeprom16(SEEP_ADDR_END_TIME_BLOCK_HOTWATER, 360);
    //WriteSmartEeprom8(SEEP_ADDR_MINIMUM_TIME_IN_HOTWATER, 10);
    //WriteSmartEeprom8(SEEP_ADDR_HOTWATER_ELEMENT_ON_AFTER_TIME, 60);
    //WriteSmartEeprom8(SEEP_ADDR_HOTWATER_ELEMENT_MAX_ON_TIME, 60);
    //WriteSmartEeprom8(SEEP_ADDR_PUMP_ON_TIME_AFTER_OFF_TIME_REACHED, 5);      
    WriteSmartEeprom8(SEEP_ADDR_DIGITAL_INPUT_TWO, 0);
    ...
    WriteSmartEeprom16(SEEP_ADDR_CIRCULATION_PUMP_MAX_OFF_TIME_WHEN_SWITCHING_TO_HEATING, 300);
    WriteSmartEeprom16(SEEP_ADDR_CIRCULATION_PUMP_INIT_OFF_TIME_WHEN_SWITCHING_TO_HEATING, 30);
    WriteSmartEeprom16(SEEP_ADDR_CIRCULATION_PUMP_OFF_TIME_WHEN_HEATPUMP_RUNNING, 120);
    ...
    WriteSmartEeprom16(SEEP_ADDR_POWER_CONTROL_TIME_CONSTANT_SEC, 20);
    WriteSmartEeprom16(SEEP_ADDR_TARGET_RISE_TEMP_1000, 30);
    WriteSmartEeprom16(SEEP_ADDR_BIG_INCREASE_STEP_HZ, 5);
    WriteSmartEeprom16(SEEP_ADDR_SMALL_INCREASE_STEP_HZ, 2);
    WriteSmartEeprom16(SEEP_ADDR_BIG_DECREASE_STEP_HZ, 5);
    WriteSmartEeprom16(SEEP_ADDR_SMALL_DECREASE_STEP_HZ, 2);
}


void printCustomEepromParameters() {
//        SYS_CONSOLE_PRINT("\nSEEP_ADDR_EVU_CONTACT_ENABLE:                        %i\n", ReadSmartEeprom8(SEEP_ADDR_EVU_CONTACT_ENABLE));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_COOLING_CONTACT_ENABLE:                    %i\n", ReadSmartEeprom8(SEEP_ADDR_COOLING_CONTACT_ENABLE));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_HEATPUMP_WAS_ON_BEFORE_FORCED_OFF:         %i\n", ReadSmartEeprom8(SEEP_ADDR_HEATPUMP_WAS_ON_BEFORE_FORCED_OFF));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_SWITCH_HEATPUMP_ON_OFF_WITH_THERMOSTAT:    %i\n", ReadSmartEeprom8(SEEP_ADDR_SWITCH_HEATPUMP_ON_OFF_WITH_THERMOSTAT));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_SOFTWARE_RESET:                            %i\n", ReadSmartEeprom8(SEEP_ADDR_SOFTWARE_RESET));
...
//        SYS_CONSOLE_PRINT("SEEP_ADDR_PUMP_ON_TIME_AFTER_OFF_TIME_REACHED:       %i\n", ReadSmartEeprom16(SEEP_ADDR_PUMP_ON_TIME_AFTER_OFF_TIME_REACHED_SEC));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_HEATING_TIME_CONSTANT_SEC:                 %i\n", ReadSmartEeprom16(SEEP_ADDR_HEATING_TIME_CONSTANT_SEC));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_END_TIME_SILENT_MODE:                      %i\n", ReadSmartEeprom16(SEEP_ADDR_END_TIME_SILENT_MODE));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_BOOST_MODE:                                %i\n", ReadSmartEeprom8(SEEP_ADDR_BOOST_MODE));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_USE_SILENT_MODE_TIMERS:                    %i\n", ReadSmartEeprom8(SEEP_ADDR_USE_SILENT_MODE_TIMERS));
//        SYS_CONSOLE_PRINT("SEEP_ADDR_BLOCK_HOTWATER:                            %i\n\n", ReadSmartEeprom8(SEEP_ADDR_BLOCK_HOTWATER));
...
{    
    ...
    if (thisEepromVersion < 2000015) {
        ...
        WriteSmartEeprom16(SEEP_ADDR_MINIMUM_TARGET_COMPRESSOR_FREQUENCY, 30);
        WriteSmartEeprom16(SEEP_ADDR_MAXIMUM_TARGET_COMPRESSOR_FREQUENCY, 100);
        WriteSmartEeprom16(SEEP_ADDR_POWER_CONTROL_TIME_CONSTANT_SEC, 180);
        WriteSmartEeprom16(SEEP_ADDR_TARGET_RISE_TEMP_1000, 3);
        WriteSmartEeprom16(SEEP_ADDR_BIG_INCREASE_STEP_HZ, 5);
        WriteSmartEeprom16(SEEP_ADDR_SMALL_INCREASE_STEP_HZ, 2);
        WriteSmartEeprom16(SEEP_ADDR_BIG_DECREASE_STEP_HZ, 5);
        WriteSmartEeprom16(SEEP_ADDR_SMALL_DECREASE_STEP_HZ, 2);
