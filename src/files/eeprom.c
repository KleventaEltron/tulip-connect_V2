...
void restoreEepromValuesToDefault(void)
{
    ...
    WriteSmartEeprom16(SEEP_ADDR_HEATING_SETPOINT, 50);
    WriteSmartEeprom16(SEEP_ADDR_COOLING_SETPOINT, TEMPERATURE_ALARM_VALUE);
    WriteSmartEeprom16(SEEP_ADDR_HOT_WATER_SETPOINT, 50);
    ...
    WriteSmartEeprom16(SEEP_ADDR_EMERGENCY_MODE_ENABLED, false);
