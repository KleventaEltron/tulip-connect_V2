...
void restoreEepromValuesToDefault(void)
{
    ...
    WriteSmartEeprom16(SEEP_ADDR_HYBRID_SYSTEM_ENABLED, false);
    WriteSmartEeprom16(SEEP_ADDR_HYBRID_SYSTEM_ENABLED_ON_HEATING_ELEMENT_RELAIS, false);
    
    WriteSmartEeprom16(SEEP_ADDR_HEATING_MODE_MAX_TIME_WITH_ELEMENT_ON, 3600);
