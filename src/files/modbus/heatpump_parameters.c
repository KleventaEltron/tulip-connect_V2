...
void SetDataInArrays(uint16_t address, uint16_t data)
{
    ...
    if ((address >= REGISTERS_AMOUNT_REAL_TIME_DATA_1) && (address < REGISTERS_AMOUNT_REAL_TIME_DATA_1 + REGISTERS_AMOUNT_REAL_TIME_DATA_1))
    {
        ...
        RealTimeData1[address][PARAMETER_ARRAY_DATA_READ_FROM_HEATPUMP][PARAMETER_ARRAY_DATA_READ_FROM_HEATPUMP] = data;
        RealTimeData1[address][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY][PARAMETER_ARRAY_DATA_READ_FROM_HEATPUMP] = data;
    }
...
void SetDataInArraysAtStartup(void)
{
    ...
    for (i = REGISTERS_AMOUNT_REAL_TIME_DATA_2; i < (REGISTERS_AMOUNT_REAL_TIME_DATA_2 + REGISTERS_AMOUNT_REAL_TIME_DATA_2); i++)
        SetDataInArrays(i, UINT16_MAX);
