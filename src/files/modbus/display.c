...
{    
    ...
    */  
    ...
    // Make static settings available for display:
    UnitSystemParameters[ADDRESS_PARAMETER_PASSWORD_SETTING - START_ADDRESS_UNIT_SYSTEM_PARAMETERS][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY] = 255;
    UnitSystemParameters[ADDRESS_TANK_TEMPERATURE_PROBE_ENABLED - START_ADDRESS_UNIT_SYSTEM_PARAMETERS][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY] = TANK_TEMPERATURE_PROBE_DISABLED;
    UnitSystemParameters[ADDRESS_UNIT_TEMPERATURE_CONTROL_METHOD - START_ADDRESS_UNIT_SYSTEM_PARAMETERS][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY] = UNIT_TEMPERATURE_CONTROL_METHOD_RETURN_WATER;
