...
{    
    ...
    */  
    ...
    RealTimeData1[ADDRESS_WATER_TANK_TEMPERATURE - REGISTERS_AMOUNT_REAL_TIME_DATA_2][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY][MASTER_HEATPUMP_IN_CASCADE] = (GetNtcTemperature(NTC_HOT_WATER_BUFFER) / 10); 
    RealTimeData1[ADDRESS_RETURN_WATER_TEMPERATURE_T6 - REGISTERS_AMOUNT_REAL_TIME_DATA_2][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY][MASTER_HEATPUMP_IN_CASCADE] = (GetNtcTemperature(NTC_HEATING_BUFFER) / 10);
    
    // Test for displaying more slaves in cascade
    RealTimeData1[ADDRESS_CASCADE_SLAVES_ONLINE_1 - REGISTERS_AMOUNT_REAL_TIME_DATA_1][PARAMETER_ARRAY_DATA_SEND_TO_DISPLAY][MASTER_HEATPUMP_IN_CASCADE] = 0xFFFE;
