...
#define CASCADE_SLAVE_1_MODBUS_ADDRESS  0x02
#define CASCADE_SLAVE_2_MODBUS_ADDRESS  0x03
#define CASCADE_SLAVE_3_MODBUS_ADDRESS  0x04
#define CASCADE_SLAVE_4_MODBUS_ADDRESS  0x05
#define CASCADE_SLAVE_5_MODBUS_ADDRESS  0x06
#define CASCADE_SLAVE_6_MODBUS_ADDRESS  0x07
#define CASCADE_SLAVE_7_MODBUS_ADDRESS  0x08
#define CASCADE_SLAVE_8_MODBUS_ADDRESS  0x09
#define CASCADE_SLAVE_9_MODBUS_ADDRESS  0x0A
#define CASCADE_SLAVE_10_MODBUS_ADDRESS 0x0B
#define CASCADE_SLAVE_11_MODBUS_ADDRESS 0x0C
#define CASCADE_SLAVE_12_MODBUS_ADDRESS 0x0D
#define CASCADE_SLAVE_13_MODBUS_ADDRESS 0x0E
#define CASCADE_SLAVE_14_MODBUS_ADDRESS 0x0F
#define CASCADE_SLAVE_15_MODBUS_ADDRESS 0x10
