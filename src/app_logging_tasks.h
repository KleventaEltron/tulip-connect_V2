...
typedef enum
{
    ...
    APP_LOGGING_TASKS_SEND_REQUEST_SSL,
            ...
            APP_LOGGING_TASKS_READ_RECEIVE_BUFFER,
            
    APP_LOGGING_TASKS_CHECK_FOR_UPDATE_SETTINGS,
            
    APP_LOGGING_TASKS_WAIT_RECEIVE_SOCKET_READY,
            
            APP_LOGGING_TASKS_REQUEST_UPDATE_SETTINGS,
            
            APP_LOGGING_TASKS_WAIT_RECEIVE_SOCKET_READY_UPDATE_SETTINGS,
            
            APP_LOGGING_TASKS_READ_RECEIVE_BUFFER_UPDATE_SETTINGS,
            
            APP_LOGGING_TASKS_PARSE_UPDATE_SETTINGS,
            
            APP_LOGGING_TASKS_WAIT_FOR_NEW_SETTINGS_CHANGED,
            
            APP_LOGGING_TASKS_SEND_NEW_SETTINGS_OVERVIEW,
            
            APP_LOGGING_TASKS_WAIT_CONFIRM_CHANGED_SETTINGS,
            
            APP_LOGGING_TASKS_READ_RECEIVE_BUFFER_SETTINGS_UPDATED,
